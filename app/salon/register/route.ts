...
export async function POST(req: Request) {
  ...
  // 1) Verifieer token -> haal user op
  ...
  // 2) Zet (of update) profielrol naar salon_owner
  // (als je later medewerkers wil, kun je dit uitbreiden)
